...
class UserController {
    ...
    static loginUser = asyncHanlder(async (req, res) => {
    ...
    static logoutUser = asyncHanlder(async (req, res) => {
    ...
    static refreshAccessToken = asyncHanlder(async (req, res) => {
    ...
    static changeCurrentPassword = asyncHanlder(async (req, res) => {
    ...
    static updateAccountDetails = asyncHanlder(async (req, res) => {
        ...
        const user = await User.findByIdAndUpdate(
            ...
            { new: true } // return value after updation
        ).select("-password");
